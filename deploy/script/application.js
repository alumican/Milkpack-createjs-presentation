(function() {
  ...
  Application = (function(_super) {
    ...
    Application.prototype.preloader = null;
    ...
    Application.prototype.onInit = function() {
      var files, i, lineGraphics, loadQueue, loadQueueFunc, pageIndex, pageType, search, simpleCreatejs, _i, _ref1,
        _this = this;
      ...
      ++this.pageLength;
      for (i = _i = 0, _ref1 = this.pageLength - 2; 0 <= _ref1 ? _i < _ref1 : _i > _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
      ...
      this.preloader = new createjs.Text('0', '140px Arial', '#333');
      this.preloader.textAlign = 'center';
      this.preloader.regY = 70;
      ...
      files = (function() {
        ...
        _results = [];
        for (i = _j = 0, _ref2 = this.pageLength; 0 <= _ref2 ? _j < _ref2 : _j > _ref2; i = 0 <= _ref2 ? ++_j : --_j) {
          _results.push({
            id: "" + i,
            src: "" + this.root + "image/page_" + (('000' + (i + 1)).substr(-4, 4)) + ".png"
          });
        }
        return _results;
      }).call(this);
      loadQueue = simpleCreatejs.createLoadQueue(files, createjs.Sound);
      loadQueue.onProgress = function(queue) {
        var ratio;

        ratio = queue.loaded / queue.total;
        return _this.preloader.text = Math.floor(ratio * 100);
      };
      loadQueueFunc = function() {
        return loadQueue.load();
      };
      return this.addCommand(new jpp.command.Func(loadQueueFunc, [], loadQueue, 'complete'), new jpp.command.Tween(this.preloader, {
        alpha: 0
      }, null, 0.5, jpp.util.Easing.easeOutQuart), function() {
        var file, node, nodeColor, nodeFragment, nodeIndex, nodeLevel, page, view, _j, _k, _len, _ref2;
        ...
        _this.pages = [null];
        for (i = _k = 1, _ref2 = _this.pageLength - 1; 1 <= _ref2 ? _k < _ref2 : _k > _ref2; i = 1 <= _ref2 ? ++_k : --_k) {
    ...
    Application.prototype.resize = function() {
      ...
      if (this.preloader) {
        this.preloader.x = this.stageWidth / 2;
        return this.preloader.y = this.stageHeight / 2;
      }
    };
...
(function() {
  ...
  Page = (function() {
    ...
    Page.prototype.focusZoomScale = 1;
    ...
    function Page(manager, stage, index, level, fragment, color, image) {
      ...
      this._base.onClick = function(event) {
        if (_this._isFocused) {
          if (event.stageX < _this._manager.stageWidth / 2) {
            return _this._manager.gotoPrevPage();
          } else {
            return _this._manager.gotoNextPage();
          }
        } else {
    ...
    Page.prototype.resizeTo = function(width, height, useTransition, execute, isFocused) {
      ...
      } else if (height > this._defaultHeight) {
        this.focusZoomScale = height / this._defaultHeight;
        width = width / this.focusZoomScale;
        height = this._defaultHeight;
      }
      viewRegX = width / 2;
      viewRegY = height / 2;
...
(function() {
  ...
  IndexScene = (function(_super) {
    ...
    IndexScene.prototype._onHello = function() {
      ...
      this.addCommand(new jpp.command.Tween(this.moveContainer, {
        x: targetX,
        y: targetY,
        scaleX: targetScale,
        scaleY: targetScale,
      ...
      if (this.manager.getTargetFragment() === this.getFragment()) {
        return this.addCommand(new jpp.command.Wait(1));
      }
    };
    ...
    IndexScene.prototype.startLoop = function() {
      var angle, easing, radius, rotation0, rotation1, scale0, scale1, time, x0, x1, y0, y1, _ref1, _ref2,
        _this = this;
      ...
      this._loopIndex = 1;
      if ((_ref2 = this._loopCommand) != null) {
        _ref2.interrupt();
      }
...
(function() {
  ...
  LastScene = (function(_super) {
    ...
    function LastScene() {
      ...
      this._onArrive = __bind(this._onArrive, this);
      this._onHello = __bind(this._onHello, this);
      this._onInit = __bind(this._onInit, this);      _ref = LastScene.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    LastScene.prototype._onArrive = function() {
      ...
      this.resizeTo(this.manager.stageWidth, this.manager.stageHeight);
      ...
      time = 2;
      easing = jpp.util.Easing.easeInOutQuart;
      return this.addCommand(new jpp.command.Parallel(new jpp.command.Tween(this.zoomContainer, {
        scaleX: 1,
        scaleY: 1
      }, null, time, easing), new jpp.command.Tween(this.moveContainer, {
        x: targetX,
        y: targetY,
        scaleX: targetScale,
        scaleY: targetScale,
        ...
        alpha: 1
      }, null, 1, jpp.util.Easing.Linear), function() {
        return _this.stage.onClick = function(event) {
          return _this._manager.gotoSpecifiedPageByFragment('/');
        };
      });
    };
    ...
    LastScene.prototype._onLeave = function() {
      ...
      if (this.manager.getTargetFragment() === '/') {
        targetX = 200;
        targetY = 0;
        targetScale = 0.08;
        targetRotation = 0;
        time = 2;
        easing = jpp.util.Easing.easeInOutQuart;
        return this.addCommand(new jpp.command.Parallel(new jpp.command.Tween(this.moveContainer, {
          x: targetX,
          y: targetY,
          scaleX: targetScale,
          scaleY: targetScale,
          rotation: targetRotation
        }, null, time, easing), new jpp.command.Tween(this.zoomContainer, {
          scaleX: 1,
          scaleY: 1
        }, null, time, easing)), new jpp.command.Wait(1));
      }
    };
    ...
    LastScene.prototype._stageResizeHandler = function(event) {
      return this.resizeTo(this.manager.stageWidth, this.manager.stageHeight);
    };

    LastScene.prototype.resizeTo = function(stageWidth, stageHeight) {
      var rect;
      ...
      this.bitmap.scaleX = rect.scaleX;
      return this.bitmap.scaleY = rect.scaleY;
    };
...
(function() {
  ...
  PageScene = (function(_super) {
    ...
    function PageScene() {
      ...
      this._onArrive = __bind(this._onArrive, this);
      this._onHello = __bind(this._onHello, this);
      this._onInit = __bind(this._onInit, this);      _ref = PageScene.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    PageScene.prototype._onArrive = function() {
      var cos, easing, focusZoomScale, pageViewX, pageViewY, rad, sin, targetRotation, targetScale, targetX, targetY, time, zoomScale, zoomTime;
      ...
      focusZoomScale = this.page.focusZoomScale;
      easing = jpp.util.Easing.easeInOutQuart;
      if (this.pageLevel === 0) {
        time = 1;
        zoomScale = 0.8 * this.zoomContainer.scaleX;
        zoomTime = 0.5;
        easing = jpp.util.Easing.easeInOutQuart;
        /*
        time = 1
...
(function() {
  ...
  SimpleCreateJS = (function() {
    ...
    SimpleCreateJS.prototype.onProgress = null;
    ...
    function SimpleCreateJS(canvasId, frameRate, mouseRate, onResize) {
      ...
      this._loadProgressHandler = __bind(this._loadProgressHandler, this);
    ...
    SimpleCreateJS.prototype.createLoadQueue = function(files, plugins, onLoad) {
      ...
      queue.addEventListener('progress', this._loadProgressHandler);
    ...
    SimpleCreateJS.prototype._loadProgressHandler = function(event) {
      var queue;

      queue = event.target;
      return typeof this.onProgress === "function" ? this.onProgress(queue) : void 0;
    };
